  ...
  return (
    <div className="min-h-screen bg-[#0B0F19] text-white flex flex-col items-center justify-between p-4 md:p-8">
      ...
      <div className="w-full max-w-5xl grid grid-cols-1 md:grid-cols-2 gap-12 items-center my-auto">
        ...
        {/* Columna Izquierda: Presentación y textos originales */}
            ...
            <div className="space-y-4">
              ...
              <form onSubmit={handleAuth} className="space-y-4">
                ...
                <button 
                  type="submit" 
                  disabled={loading} 
                  className="w-full py-3 bg-purple-600 hover:bg-purple-700 text-white font-bold rounded-xl text-sm cursor-pointer disabled:opacity-50 shadow-lg"
                >
                ...
                <button 
                  ...
                  className="w-full text-xs text-gray-400 hover:text-purple-400 mt-2 cursor-pointer text-center"
                >

...
export default function AuthPage() {
  ...
  const [showPassword, setShowPassword] = useState(false); // Estado para el botón del ojito

  const handleSubmit = async (e: any) => {
    e.preventDefault();
    if (isLogin) {
      console.log('Iniciando sesión con:', email);
      // Aquí conectaremos Supabase: supabase.auth.signInWithPassword(...)
    } else {
      console.log('Creando cuenta con:', email);
      // Aquí conectaremos Supabase: supabase.auth.signUp(...)
    }
  };
    ...
    <div className="min-h-screen bg-[#0B0F19] flex items-center justify-center p-4 md:p-10 text-white font-sans">
      <div className="max-w-7xl w-full grid md:grid-cols-[1.5fr,1fr] gap-12 items-center">
        ...
        <div className="flex flex-col space-y-8 text-center md:text-left">
          ...
          {/* Ilustración o mock de la aplicación */}
        ...
        {/* PANEL DERECHO: Formulario de Login/Registro con ojito */}

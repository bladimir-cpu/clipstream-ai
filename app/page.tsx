  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full bg-white shadow-lg rounded-3xl p-8 text-center border border-gray-100">
        <div className="mx-auto flex items-center justify-center h-16 w-16 rounded-full bg-blue-100 text-blue-600 text-3xl mb-6">
          🎬
        </div>
        <h2 className="text-3xl font-extrabold text-gray-900">ClipStream AI</h2>
        <p className="mt-4 text-gray-600">
          Transforma tus ideas y videos largos en contenido automatizado de alto impacto con Inteligencia Artificial.
        </p>

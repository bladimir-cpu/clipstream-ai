...
// Inicialización directa y segura de Supabase para evitar fallos de fetch
...
export default function HomePage() {
  ...
  const handleAuth = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert("Ocurrió un error de conexión con el servidor de autenticación.");
    } finally {
      setLoading(false);
    }
  };
          ...
          {isLoggedIn ? (
            <div className="space-y-6 text-center py-4">
              ...
              <button 
                ...
                className="text-xs text-gray-500 hover:text-white transition underline cursor-pointer mt-4"
              >
                Cerrar Sesión
              </button>
            </div>
              ...
              <form onSubmit={handleAuth} className="space-y-4">
                <div>
                  ...
                  <input 
                    ...
                    className="w-full p-3.5 rounded-xl bg-[#0B0F19] border border-gray-700 text-white placeholder-gray-600 text-sm focus:outline-none focus:border-purple-500"
                  />
                </div>
                ...
                >
                  {loading ? 'Procesando...' : (isLoginMode ? 'Ingresar al Estudio' : 'Crear Cuenta')}
                </button>
